...
-- Configuración de envío SMTP, editable desde el panel web.
-- OJO: usa una "contraseña de aplicación" (Gmail: myaccount.google.com/apppasswords),
-- nunca tu contraseña real — así puedes revocarla sin cambiar tu clave de correo.
CREATE TABLE IF NOT EXISTS config_smtp (
    ...
    tu_nombre VARCHAR(255) DEFAULT NULL,
    pausa_min_seg INT DEFAULT 25,
    pausa_max_seg INT DEFAULT 45,
    CONSTRAINT unica_fila_smtp CHECK (id = 1)
);

INSERT IGNORE INTO config_smtp (id) VALUES (1);
